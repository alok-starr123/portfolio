                ...
                mb-10">
                    <div className="flex flex-col w-full gap-10">
                        <div className="social-link">
                            ...
                            <p className="text-xl tracking-wider lowercase md:text-2xl lg:text-3xl">as4692341@gmail.com
                            </p>
                        </div>
                        <div>
                            <div className="social-link">
                                <h2>Phone</h2>
                                <div className="w-full h-px my-2 bg-white/30" />
                                <p className="text-xl lowercase md:tetx-2xl lg:text-3xl ">
                                    +91 9060907212
                                </p>
                            </div>
                            <div className="social-link">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {socials.map((social, index) => (
                                        <a key={index} href={social.href} className="text-xs leading-loose uppercase
                                        tracking-widest md:text-sm hover:text-white/80 transition-colors
                                        duration-200">
                                            {"{ "}{social.name}{" }"}
                                            </a>
                                    ))}
