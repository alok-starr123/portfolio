...
const Hero = () => {
    ...
    <section id="home" className="flex flex-col justify-end min-h-screen">
            ...
            <div style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)" }}>
                <div ref={headerRef} className="flex flex-col justify-center gap-12 pt-16 sm:gap-16">
                    <p className="text-sm font-light tracking-[0.5rem] uppercase px-10 text-black">
                        ...
                        <div className="px-10">
                            <h1 className="flex flex-col flex-wrap gap-12 text-black uppercase banner-text-responsive sm:gap-16">Alok Singh</h1>
                        </div>
                </div>
            </div>
        ...
        <figure className="absolute inset-0 -z-50" style={{ width: "100vm", height: "100vh" }}>
